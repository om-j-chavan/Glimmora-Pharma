...
export const MOCK_FDA483_EVENTS: FDA483Event[] = [
  ...
  },
  {
    ...
    observations: [
      ...
      { id: "obs-002-2", number: 2, text: "Cleaning validation protocol not updated to reflect current API product rotation.", severity: "Major", area: "Manufacturing", regulation: "21 CFR 211.67", status: "Response Drafted", capaId: "CAPA-0038" },
    ],
    commitments: [
  ...
  },
  {
    ...
    observations: [
      { id: "obs-003-1", number: 1, text: "Temperature mapping records for stability chamber SC-04 incomplete for Q4 2025.", severity: "Major", area: "QC Lab", regulation: "EU GMP Annex 15", status: "Closed", rcaMethod: "5 Why", rootCause: "Logger battery failure during power outage.", capaId: "CAPA-0045" },
      { id: "obs-003-2", number: 2, text: "Supplier qualification file for excipient vendor ABC Labs missing current audit report.", severity: "Minor", area: "Warehouse", regulation: "EU GMP Ch.7", status: "Closed" },
    ],
    commitments: [
  ...
  },
  {
    ...
    observations: [
      { id: "obs-004-1", number: 1, text: "Change control CCR-2026-018 implemented without evaluating impact on validated cleaning procedure.", severity: "Major", area: "Manufacturing", regulation: "MHRA GMP Ch.1", status: "Open", capaId: "CAPA-0046" },
      { id: "obs-004-2", number: 2, text: "Training records for 4 operators do not cover the current revision of SOP-MAN-101.", severity: "Minor", area: "Manufacturing", regulation: "MHRA GMP Ch.2", status: "RCA In Progress", rcaMethod: "5 Why" },
    ],
    commitments: [
