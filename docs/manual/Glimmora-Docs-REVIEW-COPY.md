# FOR REVIEW — Subject-Matter Expert Copy

**Glimmora Pharma — Quality System Documentation**

**Version 0.9 — DRAFT (SME review copy)**  ·  28 July 2026

Reviewed by: _________________________   Date: _____________

> **The highlighted ❓ questions are what we need you to confirm.** Wherever you see a **❓ To confirm** note in the text, please tell us what actually happens on your screen. The two key questions below matter most — they change how work is done, so we need a definite answer.

---

## What we need confirmed

> **Key question 1 — Rejecting a deviation**
>
> When someone **rejects** a deviation, what actually happens to it? Does it **stop for good** (finished as rejected), or does it **go back for more investigation**? The wording on the screen and the way the app behaves seem to disagree — please tell us the real behaviour.

> **Key question 2 — Who signs an inspection response**
>
> For an FDA-483 inspection response, can a **Regulatory Affairs** person sign and submit it, or is signing limited to the **QA Head**? The on-screen wording may say only QA Head — please confirm who can actually sign.

### The full list of points to confirm

### Questions that affect how work is done — please answer these

| # | What we need you to confirm |
|---|---|
| 1 | Reject a deviation in a test record. Where does it go — truly back to investigation, or a dead stop? **Two documents get corrected at once.** Fix both manuals and flag the mismatch to the build team. _(this affects how work is actually done — please give a definite answer.)_ |
| 2 | Sign in as a non-oversight role (e.g. QC Lab Director). Click each headline tile. Does it open something useful, get refused, or bounce back? Record what happens per tile. |
| 3 | As a non-oversight role, click a tile / heatmap cell / plan row and compare the count with the list you land on. Confirm the "shorter list is normal" explanation holds. |
| 4 | Mark a readiness task complete in a test inspection. Is there any way to reopen it? If yes, both manuals must change. |
| 5 | Sign in as Regulatory Affairs. Can you actually sign and submit a response? Read the on-screen wording and confirm it isn't wrongly limiting it to QA Head. **Fixes three documents.** |
| 6 | On an older corrective action, confirm the original author is firmly identified, not just name-matched. Where it's name-matched, treat the independence check as unreliable. **Fix-the-app item for old records.** _(this affects how work is actually done — please give a definite answer.)_ |
| 7 | As a non-oversight role, look at the corrective-action tile. Is it empty, a number, or hidden? Record what that role sees. |
| 8 | Archive a risk as Customer Admin. Is there a success (or failure) message? If it can fail silently, keep the caution; if it confirms clearly, soften it. |
| 9 | Open an inspection's Observations. Is there an import-from-document option? If yes, it deserves a walkthrough; if no, remove the tag. |
| 10 | Confirm the exact wording shown when a limit is reached, and that the manual's plain-language version matches. |
| 11 | Open a deviation task in My Work. Is there a separate "Save notes", or only notes-at-submit? Correct the manual to match. |
| 12 | As the raiser of a finding, try to change its **area**. Does the screen allow it? Confirm whether "area" belongs in the raiser's limited-edit set. |
| 13 | Check whether the standard readiness tasks have due dates. If none do, note that "Overdue" won't normally appear. |
| 14 | Walk Support end to end in the live app: who can reply, escalate, resolve, close, reopen, cancel; the fields; the statuses; whether anything is password-signed. Fill the chapter from what you find. _(this chapter is provisional — it was not reviewed, so please confirm the whole flow.)_ |
| 15 | Walk a validation stage: prepare → submit → approve/reject → sign-off. Confirm the exact steps and gates, who assigns a rework task, whether the person who prepared a stage may approve it, and whether sign-off asks for a password. _(this chapter is provisional — it was not reviewed, so please confirm the whole flow.)_ |

### Wording and labels to confirm

| # | What we need you to confirm |
|---|---|
| 16 | Confirm the exact tile names and how many tiles there are. |
| 17 | Confirm the default period and the list of period choices. |
| 18 | Confirm the click target of a heatmap cell. |
| 19 | Confirm what the Summary view actually shows. |
| 20 | Confirm the exact columns. |
| 21 | Confirm the exact filters available. |
| 22 | Confirm the exact columns and any filters. |
| 23 | Confirm the exact columns and filters. |
| 24 | Confirm the section names and arrangement on the detail page. |
| 25 | Confirm the exact tab names (including the history tab). |
| 26 | Confirm the word "commitments" appears on screen. |
| 27 | Record a root cause on an observation and read the status label it shows at that point. Confirm the manuals' wording. |
| 28 | Confirm the exact filters. |
| 29 | Confirm the exact tiles. |
| 30 | Confirm the exact status labels shown. |
| 31 | Confirm the exact columns and filters. |
| 32 | Confirm the exact report name. |
| 33 | Confirm the exact tab names. |
| 34 | Confirm the labels shown for an inspection in preparation vs closed out. |
| 35 | Confirm the exact tiles. |
| 36 | Confirm the exact status wording. |
| 37 | Confirm the exact tab names. |
| 38 | Open **Settings → People → Add** (and a person's edit). Confirm where the site is set, and that site-less roles (QA Head, Customer Admin) don't require one. |
...
The Dashboard is one page with several parts. ❓ **To confirm:** please check the exact tiles, labels, and click targets on your screen — the names below are descriptive.
...
❓ **To confirm:** please check the exact tile names and how many there are.
...
> everyone else sees their own share. ❓ **To confirm:** please check exactly where each tile takes you, and what a non-QA-Head user sees when they click a headline tile — some tiles lead toward the scorecards, which only QA Head and Customer Admin can open.
...
- A **readiness heatmap** — a grid showing how each area is doing. Selecting a cell takes you to the
  related findings. ❓ **To confirm:** please check the click target.
...
1. Use the **time** filter to change the period the Dashboard covers. It starts on a recent window by
   default. ❓ **To confirm:** please check the default period and the choices offered.
...
| **Clicking a headline tile didn't take me where I expected** | Some tiles lead toward the scorecards, which only QA Head and Customer Admin can open. ❓ **To confirm:** please check what a non-oversight role sees when selecting these tiles. |
...
| **The corrective-action numbers look empty for me** | The corrective-action detail is shown in full to QA Head and Customer Admin. Other roles reach their own corrective-action work through **My Work**. ❓ **To confirm:** please check what the tile shows for a non-oversight role. |
...
where attention is needed at a glance. ❓ **To confirm:** please check the exact counts and charts shown here.
...
- **Columns** you'll see include the finding's reference, a short title, its **severity** (Critical,
  ...
  section 7), its owner, and its target date. ❓ **To confirm:** please check the exact column set on your screen.
- **Filters and search** let you narrow the list — for example, to open findings, or a particular
  severity. ❓ **To confirm:** please check the exact filters available.
...
serious and how urgent), its **status** (see section 7), and who reported it. ❓ **To confirm:** please check the exact columns and any filters on your screen.
...
| **Rejected** | QA Head has rejected it. ❓ **KEY QUESTION —** when a deviation is rejected, does it stop for good, or go back for more investigation?|
...
owner. ❓ **To confirm:** please check the exact columns and filters on your screen.
...
❓ **To confirm:** please check the exact names and arrangement of these sections on your screen.
...
❓ **To confirm:** please check the exact tab names on your screen.
...
- **History** — the record of who did what on this inspection. ❓ **To confirm:** please check the exact name of this tab.
...
❓ **To confirm:** please check whether your screen also offers importing observations from an inspection document.
...
1. In **Response**, work through the readiness steps until they're all met:
   ...
   - all commitments are complete or withdrawn. ❓ **To confirm:** please check the word "commitments" on your screen.
...
| **I raised the observations but can't sign the response** | Signing and submitting the response is reserved for QA Head and Regulatory Affairs, because it's a signed action. ❓ **KEY QUESTION —** can Regulatory Affairs (not only QA Head) sign and submit the response?|
...
- **Search and filters** let you narrow the collection — for example, by where a document came from.
  ❓ **To confirm:** please check the exact filters on your screen.
- **The tiles** at the top give you counts: how many documents in total, how many you can edit, how
  many are locked, and how many are recent. ❓ **To confirm:** please check the exact tiles.
...
The library separates documents you manage from documents that belong to other records. ❓ **To confirm:** please check the exact status labels shown on your screen.
...
- **Columns** include the risk's title, its **category**, its **severity** and **likelihood** (how bad
  it would be and how likely it is), its owner, and its **status** (see section 7). ❓ **To confirm:** please check the exact columns and filters.
...
In **KPIs**, use the export option to produce the quality report. ❓ **To confirm:** please check the exact report name on your screen.
...
| **I archived something and nothing seemed to happen** | ❓ **To confirm:** does this show a confirmation, or fail silently? Refresh the list to check whether it archived; if it's still there, try again or ask your QA Head. |
...
The area has a few views. ❓ **To confirm:** please check the exact tab names on your screen.
...
| **I can't reopen a task I marked complete** | Completing a readiness task is final — there's no undo. ❓ **To confirm:** please check this in the live app before relying on it. |
...
You may also see **Overdue** on a task that has a due date that has passed. ❓ **To confirm:** please check whether your tasks carry due dates.
...
❓ **To confirm:** please check the labels shown for the inspection itself while it's being prepared and once it's closed out.
...
are **overdue**, how many are **due this week**, and how many are **waiting on you**. ❓ **To confirm:** please check the exact tiles on your screen.
...
❓ **To confirm:** please check this on your screen.
...
way. ❓ **To confirm:** please check the exact wording on your screen.
...
**Sites**, and **Standards**; the others are for viewing. ❓ **To confirm:** please check the exact tab names on your screen.
...
| **I can't add another person or site** | You may have reached your plan's limit for people or sites. ❓ **To confirm:** please check the exact message; if so, this is handled at the organisation level — check with your account contact. |
...
3. **Lena** goes to **Investigation** and records the observation's **root cause**.
   - *Status after:* the observation now carries a root cause. ❓ **To confirm:** please check the exact status label the observation shows at this point.
...
6. **Lena** works through the readiness steps, selects **Sign & Submit**, confirms the meaning of her
   ...
   - *Why Lena can sign:* signing an inspection response is allowed for Regulatory Affairs as well as
     QA Head. ❓ **To confirm:** please check the on-screen wording, which may mention only QA Head.
...
| 3 | Lena (Regulatory Affairs) | Records the observation's root cause | Observation: root cause recorded ❓ **To confirm:** please confirm this against your screen.|
...
QA Head and Customer Admin (and Platform Admin, who sits outside sites). ❓ **To confirm:** please check the exact place you set a person's site on your screen.
...
- **Fill (own, limited)** — the person who raised a finding can correct its own details (the
  ...
  severity or status. ❓ **To confirm:** please check whether the raiser can change the "area" — the audit is not certain the screen allows it even though the rules suggest it.
...
- **Signed action?** **Yes — this asks for your password.**
- **Status after:** ❓ **KEY QUESTION —** when a deviation is rejected, does it stop for good, or go back for more investigation?
...
| **Rejected** | A QA Head has rejected it. ❓ **KEY QUESTION —** when a deviation is rejected, does it stop for good, or go back for more investigation?|
...
❓ **To confirm:** please check — older records.** For corrective actions raised before the original author was firmly
...
**If the password is wrong**, the action does not go through, nothing changes, and the attempt is
recorded. Enter the correct password and try again. (See the ❓ **To confirm:** please check in section 4 about how the "different person" rule is checked on older records.)
...
> ❓ **To confirm for this table:** can Regulatory Affairs sign here; can Regulatory Affairs close or sign off here? And does the sign-off here ask for a password?
...
- **Sign / Close** — ❓ **KEY QUESTION —** can Regulatory Affairs (not only QA Head) sign and submit the response?
...
- **Signed action?** No.
- **Status after:** the observation carries a root cause. ❓ **To confirm:** please check the exact status label at this point.
...
- **Who:** QA Head or Regulatory Affairs ❓ *(see Key question 2)*.
...
may name only QA Head. ❓ **KEY QUESTION —** can Regulatory Affairs (not only QA Head) sign and submit the response? **If the password is wrong**, the action does
...
| **I drafted the response but can't sign it** | Signing is for QA Head and Regulatory Affairs. | ❓ **To confirm:** please check the on-screen wording, which may mention only QA Head. |
...
❓ **To confirm:** please check the exact status labels shown on your screen.
...
- **Signed action?** No.
- **Status after:** archived (removed from the active list). ❓ **To confirm:** please check whether the screen confirms this clearly — it may not.
...
- **Who:** QA Head or Customer Admin.
- **Opens and clicks:** the **KPIs** view → the export option. ❓ **To confirm:** please check the exact report name.
...
| **I archived something and nothing seemed to happen** | ❓ **To confirm:** please check archiving may not always confirm. | Refresh the list to check; if it's still there, try again or ask QA Head. |
...
- **Gate:** none.
- **Signed action?** No.
- **Status after:** the task is **Complete**, and the readiness score goes up. ❓ **To confirm:** please check whether a completed task can be reopened — the audit indicates it can't.
...
| **I can't reopen a task I marked complete** | Completing a readiness task appears to be final. | ❓ **To confirm:** please check this in the live app. |
...
You may also see **Overdue** on a task whose due date has passed. ❓ **To confirm:** please check whether readiness tasks carry due dates.
...
> is marked ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen. rather than guessed. Treat this
...
a user, answered by a handler, and closed when it's resolved. ❓ **To confirm:** this was not reviewed; please check the exact purpose and shape of the Support process in the live app.
...
> ❓ **To confirm for this table:** can Everyone do the work here; can Everyone assign work to others; can Everyone review submitted work; can Everyone close or sign off here? And does the sign-off here ask for a password?
...
- **Handling** a request appears to sit with an administrator level and a platform level, but who may
  reply, escalate, resolve, or close is ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen..
- No signed step is known here, so the Sign column is dashed — ❓ **To confirm:** please check that nothing in Support asks for a password.
...
- **Fills in:** ❓ **To confirm:** this was not reviewed; please check the required fields.
...
- ❓ **To confirm:** this was not reviewed; please check how replies are entered and what else happens.

### Step 3 — Escalate
- **What happens:** an escalation alerts the platform-level administrators. This is confirmed.
- **Who may escalate, and when:** ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen.
...
- **Who may resolve, close, reopen, or cancel, and the exact steps:** ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen.

## 4. The independence rules

❓ **To confirm:** this was not reviewed; please check whether Support has any separate-person requirements. None are known.

## 5. Signing & closing

No signed step is known in Support. ❓ **To confirm:** this was not reviewed; please check that no Support action asks for a password.
...
| **Anything else** | ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen. | Confirm the real blockers in the live app. |
...
each means are ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen.
...
> are marked ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen.. Treat the flow as a well-informed
...
off when its stages are complete. ❓ **To confirm:** this was not reviewed; please check the overall shape in the live app.

## 2. Who takes part

*(Roles are from the app's shared definitions and are reliable. What each does at each screen is
❓ **To confirm:** please confirm this against your screen..)*
...
> ❓ **To confirm for this table:** can CSV / Validation Lead assign work to others; can CSV / Validation Lead sign here; can QA Head assign work to others; can QA Head sign here; can QA Head close or sign off here? And does the sign-off here ask for a password?
...
- **Raise / Fill** — creating a system and preparing its validation stages is for the **CSV/Validation
  ...
  off is **QA Head's**.
- Whether the sign-off asks for a **password** is ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen..
- A person can also be given a **stage rework task**, which appears in their **My Work** — see step 4.

## 3. The process, step by step

> The order and the roles are well-informed; the exact fields, buttons, and gates are ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen..
...
- **Fills in:** ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen.
- **Signed action?** No.
- **Status after:** the stage is **Draft**.

### Step 2 — Submit the stage for review
- **Who:** CSV/Validation Lead.
- **Gate:** the stage's documents are prepared. ❓ **To confirm:** please check the exact gate.
- **Signed action?** No.
...
- **Signed action?** ❓ **To confirm:** this was not reviewed; please check whether approval asks for a password.
...
- ❓ **To confirm:** this was not reviewed; please check who assigns the task and the exact steps.

### Step 5 — Sign off the system
- **Who:** QA Head.
- **Gate:** the system's stages are complete. ❓ **To confirm:** please check the exact gate.
- **Signed action?** ❓ **To confirm:** this was not reviewed; please check whether sign-off asks for a password.
...
- ❓ **To confirm:** this was not reviewed; please check any other separate-person rules, for example whether the person who prepared a stage may also approve it.

## 5. Signing & closing

Signing off a validation stage or system appears to be a QA Head action. **Whether it is a
password-signed action is ❓ **To confirm:** this part was not covered in our review; please confirm it against your screen.

## 6. Where it can stall

| What the user sees | Why | What to do |
|---|---|---|
| **A stage won't submit** | Its documents may not be prepared. | ❓ **To confirm:** please check the exact requirement; complete the stage's documents. |
