...
import { getDashboardStats, getOverallReadiness, getFindings, getCAPAs, getDeviations } from "@/lib/queries";
...
export default async function Page() {
  ...
  const [stats, readinessScore, findings, capas, deviations] = await Promise.all([
